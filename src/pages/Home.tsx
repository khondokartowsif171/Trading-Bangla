...
const FEATURES = [
  {
    icon: Monitor,
    titleEn: 'MT5 Terminal',
    titleBn: 'MT5 ট্রেডিং টার্মিনাল',
    descEn: 'Real-time forex BUY/SELL with SL/TP, live P&L, multi-chart layout.',
  ...
  {
    icon: Brain,
    titleEn: 'Aura AI Signals',
    titleBn: 'অরা AI সিগন্যাল স্ক্যানার',
    descEn: 'Live BUY/SELL signals for XAU/USD, EUR/USD, GBP/USD, USD/JPY.',
  ...
  {
    icon: Activity,
    titleEn: 'EA Dashboard',
    titleBn: 'EA ড্যাশবোর্ড',
    descEn: 'Expert Advisor performance stats, win rate, profit factor.',
  ...
  {
    icon: PieChart,
    titleEn: 'Live Portfolio',
    titleBn: 'লাইভ পোর্টফোলিও',
    descEn: 'Track your holdings, P&L history, and open positions in real time.',
  ...
  {
    icon: Bitcoin,
    titleEn: 'Crypto Trading',
    titleBn: 'ক্রিপ্টো ট্রেডিং',
    descEn: 'AuraCrytox — trade BTC, ETH, and major crypto pairs live.',
  ...
  },
  {
    ...
    descEn: 'Set custom price alerts on any pair — get notified instantly.',
  ...
  {
    icon: LineChart,
    titleEn: 'Advanced Charts',
    titleBn: 'অ্যাডভান্সড চার্ট',
    descEn: 'Multi-timeframe charts with indicators, SMC zones, and drawing tools.',
  ...
  {
    icon: BookOpen,
    titleEn: 'Trading Blog',
    titleBn: 'ট্রেডিং ব্লগ',
    descEn: 'Bangla trading education — strategies, analysis, and market news.',
    ...
    <div className={`relative min-h-screen ${darkMode ? 'bg-gray-950 text-white' : 'bg-white text-gray-900'} pb-20 md:pb-0`}>
      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { value: '50K+', label: isBn ? 'সক্রিয় ট্রেডার' : 'Active Traders' },
            { value: '$2.5B+', label: isBn ? 'ট্রেডিং ভলিউম' : 'Trading Volume' },
            { value: '8+', label: isBn ? 'প্রিমিয়াম ফিচার' : 'Premium Features' },
            { value: '99.9%', label: isBn ? 'আপটাইম' : 'Uptime' },
          ].map((stat, i) => (
            <motion.div
              key={stat.label}
              initial={{ opacity: 0, y: 20 }}
            ...
            {FEATURES.map((feature, i) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-xs font-semibold text-gray-500 mb-0.5">{feature.titleEn}</p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold">{t('howItWorks')}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { step: '01', titleKey: 'step1Title' as const, descKey: 'step1Desc' as const, color: 'from-yellow-500 to-amber-500' },
              { step: '02', titleKey: 'step2Title' as const, descKey: 'step2Desc' as const, color: 'from-indigo-500 to-purple-500' },
              { step: '03', titleKey: 'step3Title' as const, descKey: 'step3Desc' as const, color: 'from-emerald-500 to-teal-500' },
            ].map((item, i) => (
              <motion.div
                key={item.step}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <div className={`inline-flex w-12 h-12 rounded-xl bg-gradient-to-br ${item.color} items-center justify-center text-white font-black text-sm mb-4 shadow-lg`}>
                  {item.step}
                </div>
