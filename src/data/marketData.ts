...
export const STOCKS: Asset[] = [
  ...
  { symbol: 'ETH', name: 'Ethereum', type: 'crypto', price: 2500.00, change: -35.20, changePercent: -1.39, volume: '12.3B', high: 2560.00, low: 2470.00, prevClose: 2535.20 },
  { symbol: 'BNB', name: 'Binance Coin', type: 'crypto', price: 650.00, change: 8.50, changePercent: 1.32, volume: '2.1B', high: 658.00, low: 640.00, prevClose: 641.50 },
  { symbol: 'SOL', name: 'Solana', type: 'crypto', price: 160.00, change: 3.40, changePercent: 2.17, volume: '3.8B', high: 164.00, low: 155.50, prevClose: 156.60 },
